<script lang="ts">
	// Source: https://www.svgrepo.com/svg/371592/timer
	interface Props { size:number; rotate?:number; }
	const { size, rotate=-45 } : Props = $props();
</script>
...
<svg width={size} height={size} viewBox="0 0 16 16" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
	<path class="timer-knob" transform="rotate({rotate+45})" transform-origin="8px" fill="currentColor" d="M9.060 9.060c0.271-0.271 0.439-0.646 0.439-1.060s-0.168-0.789-0.439-1.060c-0.59-0.59-6.72-4.6-6.72-4.6s4 6.13 4.59 6.72c0.272 0.274 0.649 0.444 1.065 0.444s0.793-0.17 1.065-0.444z"></path>
